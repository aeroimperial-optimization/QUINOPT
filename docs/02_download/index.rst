...
* `Download stable release (.zip) <https://github.com/aeroimperial-optimization/QUINOPT/releases/download/v2.2/quinopt-master-v2.2.zip>`_
* `See the source code on GitHub <https://github.com/aeroimperial-optimization/QUINOPT/>`_
...
* `Download latest developer version (.zip) <https://github.com/aeroimperial-optimization/QUINOPT/archive/developer.zip>`_
* `Download latest developer version (.tar.gz) <https://github.com/aeroimperial-optimization/QUINOPT/archive/developer.tar.gz>`_
